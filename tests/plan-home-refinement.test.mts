...
describe("Plan Your Home refinement fixtures", () => {
  it("supports Welcome, contact, Q1-Q32, review, and confirmation exactly", () => {
    assert.equal(PLAN_HOME_REFINEMENT_STATES.length, 36);
    ...
    assert.equal(normalizePlanHomeRefinementState("Q32"), "q32");
