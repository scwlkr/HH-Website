...
function isClientDraftState(value: unknown): value is PlanHomeClientDraftState {
  ...
  const hasValidBedroomsCheckpointKey =
    candidate.bedroomsAndSharedBathroomsCheckpointKey === undefined ||
    candidate.bedroomsAndSharedBathroomsCheckpointKey === null ||
    (typeof candidate.bedroomsAndSharedBathroomsCheckpointKey === "string" &&
      candidate.bedroomsAndSharedBathroomsCheckpointKey.length >= 16 &&
      candidate.bedroomsAndSharedBathroomsCheckpointKey.length <= 200 &&
      uuidV4Pattern.test(candidate.bedroomsAndSharedBathroomsCheckpointKey));
  const hasValidUtilityCheckpointKey =
    candidate.utilityAndSystemsCheckpointKey === undefined ||
    candidate.utilityAndSystemsCheckpointKey === null ||
    (typeof candidate.utilityAndSystemsCheckpointKey === "string" &&
  ...
  const hasValidDesignDeskCheckpointKey =
    candidate.designDeskCheckpointKey === undefined ||
    candidate.designDeskCheckpointKey === null ||
    (typeof candidate.designDeskCheckpointKey === "string" &&
