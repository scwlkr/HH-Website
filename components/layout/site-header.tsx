      ...
      {siteConfig.nav.map((item) => (
        <Link
          ...
          className={cn(
            ...
            mobile
              ? "border border-line bg-white px-4 py-3 text-[0.8125rem] text-foreground hover:border-accent hover:bg-background"
              : "border border-transparent px-3 py-2 text-[0.8125rem] text-muted hover:border-line-strong hover:bg-background",
          )}
        >
          {item.label}
        </Link>
      ...
      <Container size="wide" className="py-4">
        <div className="hidden items-center justify-between gap-6 xl:flex">
          <Link
            ...
            className="hh-link flex min-h-12 shrink-0 items-center gap-5"
          >
            <span className="hh-drafted-chip flex h-11 w-11 shrink-0 items-center justify-center rounded-[var(--hh-radius-pill)] border border-line-strong bg-white shadow-[0_14px_20px_-22px_rgba(17,17,15,0.45)]">
              <BrandMark decorative priority sizes="32px" className="h-6 w-6" />
            </span>
        ...
        <div className="relative flex items-center justify-between xl:hidden">
          <div className="hh-drafted-chip flex h-11 w-11 shrink-0 items-center justify-center rounded-[var(--hh-radius-pill)] border border-line-strong bg-white shadow-[0_14px_20px_-22px_rgba(17,17,15,0.45)]">
            <BrandMark decorative priority sizes="32px" className="h-6 w-6" />
          </div>
          ...
          <Link
            href="/"
            aria-label={siteConfig.name}
            className="hh-link absolute left-1/2 top-1/2 flex min-h-12 min-w-12 -translate-x-1/2 -translate-y-1/2 items-center justify-center"
          >
            <BrandWordmark
              decorative
              priority
              sizes="(max-width: 640px) 9.5rem, 12rem"
              className="h-7 w-[9.5rem] sm:h-8 sm:w-[12rem]"
            />
            <span className="sr-only">{siteConfig.name}</span>
          </Link>
