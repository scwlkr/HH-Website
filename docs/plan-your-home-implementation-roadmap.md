...
| 2 | Foundation | Define the versioned 32-question registry and project-brief schemas | 1 |
...
### 2. Define the versioned 32-question registry and project-brief schemas

**Outcome:** The exact product-spec questions have stable typed persistence and display contracts before UI work begins.

**Scope**

- Implement `plan-home-v1` definition, zones, 32 stable IDs, option slugs, response schemas, public copy, summaries, scene anchors, and camera keys.
...
- Exactly 32 contiguous questions and seven ordered zones pass invariant tests.
...
- Tests cover all 32 questions, the conditional site-context path, backward edits, retained later answers, invalid progress, refresh restore, 30-day expiration, and unknown schema versions.
...
- Anonymous answers stay local until contact is supplied after question 7.
...
**Outcome:** A customer can begin a personalized home, answer questions 1–11, and create the first identified draft after question 7.
...
- Implement questions 1–11 exactly, including helper copy, text fields, conditional site context, and limits.
- Insert email/phone checkpoint after question 7 with save/resume value and manual-follow-up disclosure.
...
- Before contact, no server record is created; after valid contact, one record contains welcome and questions 1–7.
...
**Outcome:** Questions 12–14 feel integrated into one illustrated kitchen walkthrough and checkpoint at zone completion.
...
**Outcome:** Questions 15–18 work as a spatial primary-suite walkthrough and checkpoint at completion.
...
**Outcome:** Questions 19–20 clearly capture users/layout and bath sharing without visually multiplying rooms.
...
**Outcome:** Questions 21–22 work across one coherent utility-hall scene and checkpoint at completion.
...
**Outcome:** Questions 23–27 capture exterior/site priorities with visual choices and transition naturally to the design desk.
...
**Outcome:** Questions 28–31 work in the design-desk scene, including private direct uploads and safe reference links.
...
- Implement question 32, inquiry consent version, submission validation, and atomic status conversion.
...
- Review shows all 32 canonical responses and references in tour order; customers who do not own the lot see 31 prompts because site context is not applicable.
