...
construction marks while remaining conceptual rather than presenting a design
proposed for a customer.
...
3D runtime, or customer-specific generation to a walkthrough whose output is a
project brief.
