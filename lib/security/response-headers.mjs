function normalizeFirebaseEmulatorOrigin(host) {
...
export function buildContentSecurityPolicy({
  ...
  const firebaseAuthEmulatorOrigin = normalizeFirebaseEmulatorOrigin(
    firebaseAuthEmulatorHost,
  );
  const firebaseStorageEmulatorOrigin = normalizeFirebaseEmulatorOrigin(
    firebaseStorageEmulatorHost,
  );
  const connectSources = [
    ...
    ...(firebaseStorageEmulatorOrigin ? [firebaseStorageEmulatorOrigin] : []),
  ];
